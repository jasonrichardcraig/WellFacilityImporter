...
namespace WellFacilityImporter
{
    public class WellWikiDataImporter
    {
        ...
        {
            // Adjusted extraction logic based on provided HTML structure:
            ...
            int.TryParse(doc.DocumentNode.SelectSingleNode("//td[contains(text(), 'Township:')]")?.InnerText.Replace("Township:", "").Trim(), out int township);
            int.TryParse(doc.DocumentNode.SelectSingleNode("//td[contains(text(), 'Meridian:')]")?.InnerText.Replace("Meridian:", "").Trim(), out int meridian);
            int.TryParse(doc.DocumentNode.SelectSingleNode("//td[contains(text(), 'Range:')]")?.InnerText.Replace("Range:", "").Trim(), out int range);
            int.TryParse(doc.DocumentNode.SelectSingleNode("//td[contains(text(), 'Section:')]")?.InnerText.Replace("Section:", "").Trim(), out int section);
            ...
            DateTime.TryParse(doc.DocumentNode.SelectSingleNode("//td[contains(text(), 'License Date:')]")?.InnerText.Replace("License Date:", "").Trim(), out DateTime licenseDate);
            ...
            DateTime.TryParse(doc.DocumentNode.SelectSingleNode("//td[contains(text(), 'Spud Date:')]")?.InnerText.Replace("Spud Date:", "").Trim(), out DateTime spudDate);
            DateTime.TryParse(doc.DocumentNode.SelectSingleNode("//td[contains(text(), 'Final Drill Date:')]")?.InnerText.Replace("Final Drill Date:", "").Trim(), out DateTime finalDrillDate);
            double.TryParse(doc.DocumentNode.SelectSingleNode("//td[contains(text(), 'Well Total Depth:')]")?.InnerText.Replace("Well Total Depth:", "").Replace("m", "").Trim(), out double wellTotalDepth);
            double.TryParse(doc.DocumentNode.SelectSingleNode("//td[contains(text(), 'Surface Hole Latitude:')]")?.InnerText.Replace("Surface Hole Latitude:", "").Trim(), out double surfaceHoleLatitude);
            string surfaceHoleLongitude = doc.DocumentNode.SelectSingleNode("//td[contains(text(), 'Surface Hole Longitude:')]")?.InnerText.Replace("Surface Hole Longitude:", "").Trim();
            ...
            VALUES (@WellID, @WellName, @Location, @LocationAlias, @LocationAlternateAlias, @Country, @Province, @Township, @Meridian, @Range, @Section, @County, 
                ...
                {
                    cmd.Parameters.AddWithValue("@WellID", wellID ?? (object)DBNull.Value);
                    cmd.Parameters.AddWithValue("@WellName", wellName ?? (object)DBNull.Value);
                    cmd.Parameters.AddWithValue("@Location", location ?? (object)DBNull.Value);
                    cmd.Parameters.AddWithValue("@LocationAlias", locationAlias ?? (object)DBNull.Value);
                    cmd.Parameters.AddWithValue("@LocationAlternateAlias", locationAlternateAlias ?? (object)DBNull.Value);
                    ...
                    cmd.Parameters.AddWithValue("@County", county ?? (object)DBNull.Value);
                    cmd.Parameters.AddWithValue("@SurfaceHoleLatitude", surfaceHoleLatitude != 0 ? surfaceHoleLatitude : (object)DBNull.Value);
                    cmd.Parameters.AddWithValue("@SurfaceHoleLongitude", surfaceHoleLongitude ?? (object)DBNull.Value);
                    cmd.Parameters.AddWithValue("@OperatorName", operatorName ?? (object)DBNull.Value);
                    ...
                    cmd.Parameters.AddWithValue("@LicenseStatus", licenseStatus ?? (object)DBNull.Value);
